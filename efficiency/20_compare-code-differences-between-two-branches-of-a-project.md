...
1）找到对比入口；<br/>
![An image](/images/efficiency/gitCompare/git_compare.png)
2）选择要对比的分支或版本：<br/>
![An image](/images/efficiency/gitCompare/git_compare2.png)
3）查看所有改动：<br/>
![An image](/images/efficiency/gitCompare/git_compare3.png)
