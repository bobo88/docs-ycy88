...
3. build/tools/buildKey.js: 打包配置的辅助工具， 「yarn build:test b=about」中key就是「about」，它表示打包的明确目标是：测试环境 & about页面。
```js
...
4. build/config/seo.js: 用来配置SEO标题相关的信息。
```js
/**
 * 用来定义多页面的SEO配置信息
 */
...
DEMO源码参考：<br />
<a href="https://github.com/bobo88/project-basis/tree/main/vue3-multi-page" target="_blank">「VUE多页面配置」 by Bob</a><br />
